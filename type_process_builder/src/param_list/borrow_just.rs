...
impl<'a, Source, Any> BorrowJust<'a, HNil, Any> for &'a Source {
  #[inline(always)]
...
where
  ...
  <&'a HCons<SourceHead, SourceTail> as Plucker<&'a TargetHead, IndexHead>>::Remainder: BorrowJust<'a, TargetTail, IndexTail>,
{
  #[inline(always)]
