# Rust API for qrios_api_axum_server
...
- API version: 1.6.0
- Build date: 2026-02-13T19:18:26.912482387Z[Etc/UTC]
- Generator version: 7.20.0-SNAPSHOT



This autogenerated project defines an API crate `qrios_api_axum_server` which contains:
...
#[async_trait]
impl qrios_api_axum_server::apis::default::Api for ServerImpl {
  // API implementation goes here
}

impl qrios_api_axum_server::apis::ErrorHandler for ServerImpl {}
...
pub async fn start_server(addr: &str) {
    ...
    // Init Axum router
    let app = qrios_api_axum_server::server::new(Arc::new(ServerImpl));
